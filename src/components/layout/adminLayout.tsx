...
const AdminLayout = () => {
    ...
    return <div className='flex-basis'>
        {/* Header */}
        <header className="bg-indigo-500 h-[80px] flex">
            <div className="container ml-[230px] flex items-center gap-4 my-auto">                               
                ...
                <div className="font-bold text-white">Hello Admin</div>            
            </div>
        </header>
        {/* Side bar */}
        <div className='flex'>
            <aside className="w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <nav className="-mx-3 space-y-6 ">
                        <div className="space-y-3 ">
                            ...
                            <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                ...
                                <span className="mx-2 text-sm font-medium"><Link to={"/admin"}>Product List</Link></span>
                            </a>
                            ...
                            <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                ...
                                <span className="mx-2 text-sm font-medium"><Link to={"/admin/product-add"}>Add product</Link></span>
                            </a>
                        </div>

                        <div className="space-y-3 ">
                            <label className="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">category</label>
                            ...
                            <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                ...
                                <span className="mx-2 text-sm font-medium"><Link to={"/admin/category"}>Category List</Link></span>
                            </a>
                            ...
                            <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                ...
                                <span className="mx-2 text-sm font-medium"><Link to={"/admin/category-add"}>Add Category</Link></span>
                            </a>
                        </div>
                        ...
                        <div className="space-y-3 ">
                            ...
                            <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                                ...
                                <span className="mx-2 text-sm font-medium"><Link to={"/"}>Log out</Link></span>
                            </a>
            ...
            <div className="container pt-[50px] pl-[100px] pr-[100px]">
                <Outlet />
                <footer>
                </footer>
            </div>
