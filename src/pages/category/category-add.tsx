...
const CategoryAdd = () => {
    ...
    return <section className="bg-gray-100">
        ...
        <h1 className='text-3xl font-medium text-indigo-700'>Add Category</h1>
                    ...
                    <form action="" className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {/* <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    className="w-full rounded-lg border border-gray-200 p-3 text-sm" {...register("original_price")}
                                    type="number"
                                />
                                <p className='text-red-600 text-[10px]'>
